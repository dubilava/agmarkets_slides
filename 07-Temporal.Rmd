...
```{r temporal_setup_hidden, echo=FALSE, include=FALSE, message=FALSE}
library(ggplot2)
library(data.table)
...
dt <- fread("data/pink_sheet_combined_wide.csv")

dt$Date <- as.Date(dt$Date,format="%d/%m/%Y")

ggplot(dt,aes(x=Date,y=Maize_mt_dollar))+
  geom_line(color="indianred",linewidth=.8)+
  labs(x="Year",y="",subtitle="(US$/MT)",caption="retrieved from the World Bank 'Pink Sheet' Data\nhttps://www.worldbank.org/en/research/commodity-markets")+
  theme_classic()+
  theme(axis.title=element_text(size=22),axis.text = element_text(size=18),plot.caption=element_text(size=16,color="dimgray"),plot.title.position = "plot")
```
]
...
.pull-right[
```{r cobweb_image, out.width='90%', fig.align='center', echo=FALSE}
knitr::include_graphics("07-Temporal_files/figure-html/cobweb-1.png")
```
]
...
.pull-right[
```{r season_image, out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics("07-Temporal_files/figure-html/season-1.png")
```
]
