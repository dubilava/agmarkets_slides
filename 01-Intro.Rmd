...
subtitle: "Lecture 1: Introduction to Agricultural Markets"
...
Much has been said and written about soaring prices of wheat and its repercussions from March 2022 onward. 

The observed sharp price increase was of historical proportions, which happened shortly after Russia invaded Ukraine in February of 2022.

---

# Wheat futures in the wake of the war

![Export Levels](wheat_futures.png)

---

# Crisis in the Breadbasket of Europe

Russia and Ukraine constitute what is known as "the breadbasket of Europe," accounting for more than a quarter of world wheat exports. 

As a reference, combined exports from these two countries are at par with combined exports from European Union and the United States, the other two major wheat-exporting regions that used to account for more than two-fifths of the world wheat exports in the beginning of this century.

---

# Wheat export levels 

![Export Levels](export_levels.png)

---

# Wheat export shares

![Export Levels](export_shares.png)
...
The sharp increase in prices of wheat (and other cereal grains) has happened before. 

Since the beginning of this century, the markets have witnessed dramatic increase in prices in 2007-2008, and then in 2010-2011. 

Most recently, prices of wheat and maize, for example, have been on the rise since the beginning of the Covid-19 pandemic.

---

# Booms and busts of cereal prices
...
A range of other factors, everything from geopolitical events to pandemics can disrupt commodity markets.

The invasion of Ukraine is an example of a geopolitical event that triggered a significant spike in commodity prices - primarily of cereal grains and to some extent of vegetable oils as well.

The Covid-19 pandemic had a very limited *initial* impact on world food commodity prices, partly due to surprisingly resilient global food supply chains. Over time, constant disruptions and increased uncertainty became one of the major contributing factors in the 2022 food crisis.
...
Global commodity crises impact disproportionately low and middle income countries. In this group of countries, repercussions are more dire for urban population compared to rural population who may even benefit from increase in commodity prices if they produce these commodities.
...
In instances when an increase in commodity prices increases income, two effects of opposite sign are possible. One the one hand, higher farm income increases the opportunity cost of fighting, thus reducing conflict. On the other hand, higher farm income increases the opportunities for appropriation of the agricultural surplus, thus facilitating conflict.
