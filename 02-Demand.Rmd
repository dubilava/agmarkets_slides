...
```{r demand, out.width='40%', fig.asp=1.6, dpi=200, fig.align='center', echo=FALSE, warning=FALSE, cache=TRUE}
...
plot_grid(gg1,gg2,align="v",nrow=2,labels=c("Optimal Bundle","Individual Demand"),hjust=0)
```
