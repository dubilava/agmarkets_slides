...
subtitle: "Lecture 11: Agricultural Markets and Conflict"
...
- Thus, when agricultural commodity prices are high, farmers accumulate wealth, which attracts perpetrators (e.g., [McGuirk and Burke, 2020](https://www.journals.uchicago.edu/doi/full/10.1086/709993)).
]
...
.right-column[
```{r out.width='55%'}
include_graphics('Figures/bars_map_legend_violence.png')
```
]
...
# Conflict-prone countries and 'hotspots'

.right-column[
```{r out.width='55%'}
include_graphics('Figures/map_hotspots.png')
```
]
...
.right-column[
- We asked the question: <span style="color: #cd5c5c;">**Is there seasonality in violent attacks against civilians across rural Africa?**</span>
- We found that:
...
.right-column[
```{r fig.align="left", out.width = "50%", dpi=200}
...
.right-column[
- We asked the question: <span style="color: #cd5c5c;">**Does conflict impact market integration in Somalia?**</span>
- We found that:
...
[Hastings, et al. (2022)](https://academic.oup.com/jae/article-abstract/31/3/272/6299941)

[McGuirk and Burke, 2020](https://www.journals.uchicago.edu/doi/full/10.1086/709993)

[Ubilava, et al. (2022)](https://arxiv.org/abs/2202.07863)
