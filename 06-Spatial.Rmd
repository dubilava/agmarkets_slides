...
.right-column[
```{r trade, out.width='100%', fig.asp=0.5, dpi=200, fig.align='center', echo=FALSE, warning=FALSE, cache=FALSE}
...
.pull-left[
```{r structure_image, out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics("06-Spatial_files/figure-html/structure-1.png")
```
]
