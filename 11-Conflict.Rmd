...
.pull-right[
```{r map_harvest_image, out.width='80%'}
...
.pull-right[
```{r circular_violence_image, out.width='80%'}
...
.pull-right[
```{r somalia_map_image, fig.align="left", out.width = "70%", dpi=200}
...
.right-column[
```{r price_transmission_image, out.width='100%'}
